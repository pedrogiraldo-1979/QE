...
export const PROSPECT_COLUMNS =
  "id,list_id,company_name,legal_name,nit,segment,campaign,city,website,phone,address,status,priority,source,confidence_score,notes,converted_company_id,created_at,updated_at";
